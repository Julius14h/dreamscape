    ...
    <div className="relative flex items-center justify-center min-h-screen w-full">
      <div className="fixed bottom-0 flex justify-center w-full">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center w-[80%] max-w-[400px] mx-auto top-[12%] px-4">
            <h1
            ...
            <button className="mt-3 px-5 py-2.5 border border-[#D4AF37] text-[#D4AF37] text-sm rounded-lg transition-all duration-200 hover:bg-[#D4AF37]/20 hover:scale-105">
              View Previous Entries
            </button>
            <button className="mt-8 text-[#D4AF37] text-sm underline hover:text-[#D4AF37]/80 transition-colors">
              Sign Out
            </button>
          </div>
        </div>
